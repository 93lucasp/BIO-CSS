...
I'm not here to explain you these methodologies, you can find here some very good explanation: [BEM, SMACSS, OOCSS](https://medium.com/@Intelygenz/how-to-organize-your-css-with-oocss-bem-smacss-a2317fa083a7){:target="_blank"} and [ITCSS](https://www.xfive.co/blog/itcss-scalable-maintainable-css-architecture/){:target="_blank"} .
